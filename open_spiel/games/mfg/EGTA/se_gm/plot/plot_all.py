...
def draw(size, step):
    ...
    # RD = genfromtxt('../../plot/data/RD/cd_RD' + post_name + ".csv", delimiter=',')[:25]
    ...
    RD = genfromtxt('../../plot/data/RD/cd_2d_RD' + post_name + ".csv", delimiter=',')[:25]
    ...
    plt.plot(X, RD_model_mean, color="C3", label='EGTA w. GML/REG')
