...
def draw(size, step):
    ...
    # egta = genfromtxt('./baselines_1d/cd_egta' + post_name + '_consistent' + ".csv", delimiter=',')[:25]

    fp = genfromtxt('./baselines_2d/cd_2d_fp' + post_name + ".csv", delimiter=',')[:25]
    egta = genfromtxt('./baselines_2d/cd_2d_egta' + post_name + '_consistent' + ".csv", delimiter=',')[:25]
    ...
    plt.tight_layout()
    # plt.savefig('./consistent/cd' + post_name + '_consistent' + '.png')
    plt.savefig('./consistent/cd_2d' + post_name + '_consistent' + '.png')
